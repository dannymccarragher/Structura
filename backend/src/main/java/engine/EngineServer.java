...
public class EngineServer {
    ...
    private static final SimulationDispatcher dispatcher = new SimulationDispatcher(); // add this
    ...
    private static void handleSimulate(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            List<Step> steps = dispatcher.dispatch(request); // instance call, not static
